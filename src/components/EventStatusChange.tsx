...
const allStatuses: EventStatus[] = ['READY', 'OPEN', 'CLOSED', 'CANCELLED'];

const EventStatusChange = ({ event, onUpdated, mode, onClose }: Props) => {
      ...
      {mode === 'settle' ? (
        <div className="card" style={{ padding: 12 }}>
          ...
          <p className="page-sub" style={{ marginTop: 0 }}>
            CLOSED 상태에서 승리 옵션을 선택하고 정산할 수 있어요. (복수 선택
            가능)
          </p>
